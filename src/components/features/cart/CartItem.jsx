...
const Spinner = () => <Loader2 size={12} className="animate-spin text-gray-400" />;

const CartItem = ({ item, isDeleting, onIncrement, onDecrement, onRemove, onQuantityChange }) => {
  ...
  return (
    <div className={`group relative flex items-center gap-3 sm:gap-5 md:gap-6 bg-white p-3 sm:p-4 md:p-6 rounded-2xl md:rounded-[2.5rem] border border-gray-100 shadow-sm transition-all hover:shadow-md ${isDeleting ? 'opacity-50 scale-[0.99]' : ''}`}>
      <div
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 mt-2.5 md:hidden">
          <div className="flex items-center bg-gray-50 rounded-lg p-0.5 border border-gray-100">
            ...
            >
              {loadingAction === 'decrement' ? <Spinner /> : <Minus size={10} />}
            </button>
