...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="p-3 sm:p-5 border-r border-b border-gray-100 relative group transition-all hover:shadow-[0_20px_50px_rgba(0,0,0,0.06)] hover:z-10 bg-white flex flex-col min-h-[320px] sm:min-h-[420px] lg:min-h-[480px] text-left">
      ...
      >
        <div className="aspect-square w-full flex items-center justify-center mb-3 sm:mb-6 overflow-hidden rounded-xl sm:rounded-2xl border border-gray-50 bg-[#FBFBFB]">
          <img
        ...
        <div className="space-y-1.5 sm:space-y-3">
          ...
          <span className="font-black text-[#3A5A4D] text-base sm:text-lg tracking-tighter block mt-1 sm:mt-2">
      ...
      >
        <ShoppingBag size={16} className={`${isInCart ? 'sm:mr-2' : ''}`} />
        {isInCart && (
